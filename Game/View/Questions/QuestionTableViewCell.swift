...
class QuestionTableViewCell: UITableViewCell {
    ...
    private func setupCell() {
        backgroundColor = Color.scoreBackground
    }
    
    private func setupQuestionLabel(with text: String) {
        addSubview(questionLabel)
        
        questionLabel.backgroundColor = Color.scoreBackground
        questionLabel.numberOfLines = 0
        questionLabel.text = text
        questionLabel.textColor = Color.textAlternative
    ...
    private func setupAnsewerLabels(with answers: [String], correctAnswer: String) {
        ...
        for (index, label) in answerLabels.enumerated() {
            ...
            label.backgroundColor = Color.scoreBackground
            label.textColor = Color.textAlternative
            ...
            if answers[index] == correctAnswer {
                ...
                label.layer.borderColor = Color.textAlternative.cgColor
            }
        }
    }
